...
```
curl "https://nubesgen.com/fitfoot.zip?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=MYSQL.basic&addons=application_insights,key_vault&gitops=true" | tar -xzvf -
```
