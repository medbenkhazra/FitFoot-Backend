...
```
curl "https://nubesgen.com/fit.zip?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.free&runtime=SPRING&database=NONE.free&addons=application_insights&gitops=true" | tar -xzvf -
```
