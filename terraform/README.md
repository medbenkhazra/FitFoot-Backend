...
```
curl "https://nubesgen.com/rg-terraform-001.zip?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=MYSQL.basic&addons=application_insights,key_vault,storage_blob&gitops=true" | tar -xzvf -
```
