...
```
curl "https://nubesgen.com/fitfoot-backend.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=MYSQL.basic&addons=application_insights,key_vault&gitops=true&network=VIRTUAL_NETWORK" | tar -xzvf -
```
