...
```
curl "https://nubesgen.com/fitfoot-backend.tgz?iactool=TERRAFORM&region=francecentral&application=APP_SERVICE.standard&runtime=DOCKER&database=MYSQL.basic&gitops=true" | tar -xzvf -
```
