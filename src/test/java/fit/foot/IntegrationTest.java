...
import fit.foot.FitFootApp;
import fit.foot.config.AsyncSyncConfiguration;
import fit.foot.config.EmbeddedSQL;
...
@SpringBootTest(classes = { FitFootApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
