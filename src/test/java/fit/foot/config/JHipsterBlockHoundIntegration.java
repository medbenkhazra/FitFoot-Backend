...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("fit.foot.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("fit.foot.security.DomainUserDetailsService", "createSpringSecurityUser");
