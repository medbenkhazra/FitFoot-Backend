...
export class ProprietaireComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProprietaire): number => this.proprietaireService.getProprietaireIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.proprietaires = this.refineData(dataFromBody);
  }

  protected refineData(data: IProprietaire[]): IProprietaire[] {
