...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../annonce.test-samples';

import { AnnonceService, RestAnnonce } from './annonce.service';

const requireRestSample: RestAnnonce = {
...
describe('Annonce Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Annonce', () => {
      ...
      const annonce = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(annonce).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Annonce', () => {
      const annonce = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(annonce).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addAnnonceToCollectionIfMissing', () => {
      it('should add a Annonce to an empty array', () => {
        const annonce: IAnnonce = sampleWithRequiredData;
      ...
      it("should add a Annonce to an array that doesn't contain it", () => {
        const annonce: IAnnonce = sampleWithRequiredData;
        const annonceCollection: IAnnonce[] = [sampleWithPartialData];
        expectedResult = service.addAnnonceToCollectionIfMissing(annonceCollection, annonce);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(annonce);
      });
      ...
      it('should add only unique Annonce to an array', () => {
        const annonceArray: IAnnonce[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const annonceCollection: IAnnonce[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const annonce: IAnnonce = sampleWithRequiredData;
        const annonce2: IAnnonce = sampleWithPartialData;
    ...
    describe('compareAnnonce', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareAnnonce(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareAnnonce(entity1, entity2);
        const compareResult2 = service.compareAnnonce(entity2, entity1);
